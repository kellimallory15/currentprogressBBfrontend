      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-4">
        <div class="card mx-auto shadow">
          <div class="card-body">
            ...
            <div v-if="showMsg === 'loginError'" class="alert alert-danger" role="alert" dense>
              Invalid username or password. Please Try again.
            </div>
            <div v-else-if="showMsg === 'axiosError'" class="alert alert-danger" role="alert" dense>
    ...
    login() {
      ...
      apiService.authenticateLogin(this.credentials)
        .then(response => {
          ...
          localStorage.setItem("log_user", JSON.stringify(user.username));
        ...
        .catch(error => {
          ...
          this.showMsg = error.response && error.response.status === 401 ? 'loginError' : 'axiosError';
          router.push("/auth");
        });
    }
  }
    ...
    methods: {
      login(){
            ...
            .then((response) => {
                ...
                localStorage.setItem("superuser")
        ...
        apiService.getUser(user).then(response => {
                        test=response.data;
